/*
  ...
  - You are about to drop the `qusetions` table. If the table is not empty, all the data it contains will be lost.
...
-- DropForeignKey
ALTER TABLE "qusetions" DROP CONSTRAINT "qusetions_author_id_fkey";

-- AlterTable
ALTER TABLE "users" ADD COLUMN     "role" "UserRole" NOT NULL DEFAULT 'STUDENT';

-- DropTable
DROP TABLE "qusetions";
